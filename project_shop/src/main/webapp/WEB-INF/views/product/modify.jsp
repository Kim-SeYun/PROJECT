...
<%@ include file="../layout/header.jsp" %>  
	...
	<form class="container" action="${contextPath}/product/modProduct" method="post" enctype="multipart/form-data">
		<div class="form-group">
		    상품번호 <input type="text" class="form-control" name="pno" value="${productList.pno}">
		</div>
		<div class="form-group">
		    상품명 <input type="text" class="form-control" name="name" value="${productList.name}">
		</div>
		<div class="form-group">
		    가격 <input type="text" class="form-control" name="price" value="${productList.price}">
		</div>
		<div class="form-group">
		    중량X수량 <input type="text" class="form-control" name="weight" value="${productList.weight}">
		</div>
		<div class="form-group">
