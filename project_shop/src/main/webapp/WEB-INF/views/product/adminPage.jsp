		...
		<c:forEach var="product" items="${productList}">
			<tr style="text-align: center;">
				...
				<td style="padding: 10px; border: 1px solid #ddd;">
					<a href="${contextPath}/product/detail?name=${product.name}">
						<img src="${contextPath}/fileDownload?no=${product.pno}&imageFileName=${product.imageFileName}&path=product" alt="${product.name}" style="width: 100px; height: 70px;">
					</a>
				</td>
